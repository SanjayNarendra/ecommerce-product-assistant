...
async def main():
    client = MultiServerMCPClient({
        "hybrid_search": {   # server name
            ...
            "args": [
                ...
                r"D:\LLMOps\ecommerce-product-assistant\prod_assistant\mcp_servers\product_search_server.py"
            ],  # absolute path
            "transport": "stdio",
        }
    })
    ...
    # query = "Mac book pro price"
    query = "what is the price of MacBook Air?"
